<template>
  <b-container>
        ...
        <b-col md="6" class="px-3">
          ...
          <b-form-row>
            <b-col>
              <b-form-group
                id="descriptionGroup"
                label="Description / Additional Location Details (optional)"
              ...
              >
                <b-form-textarea
                  ...
                  rows="5"
                  cols="50"
                  v-b-popover.focus.top="'Please add additional details about your location such as room number and if you are in a large room, then a brief description of your area (ie: back of the room by the windows).'"
                ></b-form-textarea>
              </b-form-group>
            </b-col>
          </b-form-row>
        ...
        <b-col md="6" class="px-3">
          ...
          <b-form-row>
            ...
            <b-col id="thanosImg" cols="2">
              <b-img
                :src="require('../assets/ThanosStill.jpg')"
    ...
    <b-toast
      ...
      :visible="this.alert"
    >Please note that your end time is earlier than your start time.</b-toast>
  </b-container>
</template>
...
@keyframes glowAnimation {
  ...
  25% {
    box-shadow: inset 0px 0px 5px 3px rgb(255, 216, 40),
      0px 0px 5px 3px rgb(255, 216, 40);
