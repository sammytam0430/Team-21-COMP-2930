    ...
    <b-form  v-on:submit.prevent="">
        ...
        <b-form-group id="when-group" label="When" label-for="when">
            <b-container class="px-0">
                <b-form-row>
                    <b-col>
                        <b-form-input id="when" v-model="form.date" type="date" :disabled="now === 'true'" required placeholder="mm-dd-yyyy"></b-form-input>
                    </b-col>
                    <b-col cols="3">
                        <b-form-checkbox v-on:change="setTime()" id="checkbox-1" v-model="now" name="checkbox-1" value="true" unchecked-value="false"> 
                            Now
                        </b-form-checkbox>
                    </b-col>
                </b-form-row>
            ...
            <b-form-row>
                <b-col>
                    <b-form-group id="start-group" label="Start" label-for="start">
                        <b-form-input id="start" v-model="form.start" type="time" :disabled="now === 'true'" required placeholder="mm/dd/yyyy"></b-form-input>
                    </b-form-group>
                </b-col>
                <b-col>
...
export default {
    ...
    methods: {
        setTime() {
            ...
            let date = now.getDate() > 9 ? now.getDate() + 1 : '0' + (now.getDate() + 1);
            let hour = now.getHours() > 10 ? now.getHours() : '0' + now.getDate();
            let minute = now.getMinutes() > 10 ? now.getMinutes() : '0' + now.getDate();
